...
namespace PacManNS
{
    public class GameBoard : MonoBehaviour
    {
        ...
        void UpdateUI()
        {
            oneUpScore.text = score.ToString();
        ...
        public void StartDeath()
        {
            if (!didStartDeath)
            {
                ...
                oneUpText.GetComponent<Text>().enabled = true;
        ...
        IEnumerator ProcessRestart(float delay)
        {
            ...
            if (pacManLives == 0)
            {
                ...
                readyText.transform.GetComponent<Text>().color = new Color(164f / 255f, 4f / 255f, 4f / 255f, 255f / 255f);
